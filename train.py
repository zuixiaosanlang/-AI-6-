...
parser.add_argument("--data_dir", default="./Dataset/inpainting/", help="path to real dataset")
...
parser.add_argument("--use_da", default=0.0, type=float, help="[0~1], the precentage of synthesized dataset")
...
with tf.variable_scope(tf.get_variable_scope()):
    ...
    # loss_percep = tf.reduce_mean(tf.abs(shadow_free_image - target))
    # Adversarial Loss
